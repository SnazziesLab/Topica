...
// If topicId is null, a new Topic will be generated with a random GUID
...
// 
func (r ApiAddMessageRequest) Body(body string) ApiAddMessageRequest {
	r.body = &body
	return r
}
...
*/
func (a *MessagesAPIService) AddMessage(ctx context.Context) ApiAddMessageRequest {
	return ApiAddMessageRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return string
func (a *MessagesAPIService) AddMessageExecute(r ApiAddMessageRequest) (string, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MessagesAPIService.AddMessage")
	if err != nil {
