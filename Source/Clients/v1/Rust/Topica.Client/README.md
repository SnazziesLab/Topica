# Rust API client for Topica.Client
...
Put the package under your project folder in a directory named `Topica.Client` and add the following to `Cargo.toml` under `[dependencies]`:

```
Topica.Client = { path = "./Topica.Client" }
```
