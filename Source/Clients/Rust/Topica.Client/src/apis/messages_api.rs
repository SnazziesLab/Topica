...
pub async fn add_message(configuration: &configuration::Configuration, topic_id: Option<&str>, body: Option<&str>) -> Result<String, Error<AddMessageError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/Messages", local_var_configuration.base_path);
